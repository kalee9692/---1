...
const translations = {
    en: {
        ...
        guideIntro: 'This lotto draw picks 7 unique numbers from 1 to 45, presenting 6 winning numbers and a bonus number.',
        guideUseTitle: 'How to Use',
        guideUseText: 'Press the button to see a new set of numbers after a short animation.',
        guideOddsTitle: 'Odds Info',
        guideOddsText: 'All numbers have the same chance because the draw is random.',
        guideNoteTitle: 'Notice',
        guideNoteText: 'This service is for entertainment only and is not related to official lottery results.',
    ...
    ko: {
        ...
        termsLink: '이용약관',
        guideTitle: '서비스 안내',
        guideIntro: '이 로또 추첨기는 1부터 45까지의 번호 중 중복 없이 7개를 뽑아 6개 번호와 보너스 번호를 제공합니다.',
        guideUseTitle: '사용 방법',
        guideUseText: '버튼을 누르면 애니메이션 이후 결과가 표시됩니다. 매번 새로운 조합이 생성됩니다.',
        guideOddsTitle: '확률 정보',
        guideOddsText: '로또는 난수 기반의 랜덤 추첨이며, 특정 번호가 나올 확률은 모두 동일합니다.',
        guideNoteTitle: '이용 안내',
        guideNoteText: '이 서비스는 재미를 위한 참고용이며 실제 복권 결과와 무관합니다.',
        themeToDark: '다크 모드',
        themeToLight: '화이트 모드',
        langToKo: '한국어',
        langToEn: 'English'
